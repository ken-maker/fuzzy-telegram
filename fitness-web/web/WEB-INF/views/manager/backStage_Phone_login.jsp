...
<div id="login_div" class="layui-anim-fadein">
    <form class="layui-form">
        ...
        <div id="to_ID_login">
            <a href="${pageContext.request.contextPath}/back_login_controller/login"><<<账号密码登录</a>
        </div>
    </form>
</div>
...
<script>
    ...
    function NumberIsExist(phoneNumber,fn){
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/back_login_controller/phoneNumberIsExist",
            method:"GET",
        ...
        $("#vf_btn").click(function () {
            ...
            if (verifyPhoneNumber(phoneNumber)){
                if (NumberIsExist(phoneNumber,function () {
                    $.ajax({
                        url:"${pageContext.request.contextPath}/back_login_controller/getVerifyCode",
                        method:"GET",
                        data:{phoneNumber:phoneNumber},
                        contentType:"application/json",
                        dataType:"json"
        ...
        $("#tologin_btn").click(function () {
            ...
            if (verifyPhoneNumber(phoneNumber)){
                if (verifyVerify(verificationCode)){
                    $.ajax({
                        url:"${pageContext.request.contextPath}/back_login_controller/PhoneLogin.do",
                        method:"GET",
                        ...
                        if (data.message=="success"){
                            ...
                            window.location.href="${pageContext.request.contextPath}/back_login_controller/home?userID="+data.userID
                        }else{
